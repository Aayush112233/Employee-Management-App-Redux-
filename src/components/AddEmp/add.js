                        ...
                        <Form className="d-flex form" onSubmit={handleSubmit(submitMyForm)}>
                            <div>
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Control {...register("first_name", { required: true})} type="text" placeholder="Eg. Aayush"  />
                                    {errors?.first_name?.type === "required" && <p>This field is required</p>}
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                    <Form.Label>Last Name</Form.Label>
                                    <Form.Control {...register("last_name", { required: true })} type="text" placeholder="Eg. Neupane"  />
